...
Este portfólio reúne minha trajetória de estudos e projetos enquanto desenvolvo minha base em análise de dados. Cada seção do site documenta um passo real da minha curva de aprendizado.
...
- JetBrains Mono / Plus Jakarta Sans (Google Fonts)
